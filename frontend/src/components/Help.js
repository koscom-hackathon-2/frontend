            ...
            <div className="flex flex-col h-full overflow-x-auto mb-4 animate-fade-up animate-delay-100">
                <div className="flex flex-col">
                    ...
                    <div className="container">
                        <a href="https://datamall.koscom.co.kr/kor/main/contents.do?menuNo=200082" target="_blank"
                           className="card">
                            <div className="title">GUIDE</div>
                            <img src={guide} className="icon"></img>
                            <div className="subscript">기초 가이드를 확인하세요.</div>
                        </a>
                        <a href="https://datamall.koscom.co.kr/kor/bbs/B0000003/list.do?menuNo=200083" target="_blank"
                           className="card">
                            <div className="title">F&Q</div>
                            <img src={fnq} className="icon"></img>
                            <div className="subscript">자주 묻는 질문을 모아놨어요.</div>
                        </a>
                        <a href="https://datamall.koscom.co.kr/kor/bbs/B0000001/list.do?menuNo=200081" target="_blank"
                           className="card">
